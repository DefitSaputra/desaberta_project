<section class="relative py-24 bg-berta-dark overflow-hidden">
                ...
                <div class="relative group">
                    ...
                    <div class="relative rounded-[2rem] overflow-hidden shadow-2xl aspect-[3/4] bg-berta-wood/10 border border-white/5">
                        ...
                        <img src="{{ asset('img/kades.jpg') }}" 
                             ...
                             class="w-full h-full object-cover object-top transform transition-all duration-700 ease-in-out 
                                    filter brightness-95 saturate-75 
                                    group-hover:scale-105 group-hover:brightness-110 group-hover:saturate-120">
